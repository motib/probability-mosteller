...
\begin{prob}{Random quadratic equations\annotate{S}}
...
\begin{prob}{Two-dimensional random walk\annotate{S}}
...
\begin{prob}{Three-dimensional random walk\annotate{D,S}}
...
\begin{prob}{Buffon's needle\annotate{D, S}}
...
\begin{prob}{Long needles\annotate{D,S}}
...
Let $U_1,U_2$ be two urns containing $m$ balls each. $U_1$ has $w_1$ white balls and $b_1$ black balls, while $U_2$ has $w_2$ white balls and $b_2$ black balls. $n$ balls are drawn \emph{with replacement} from each urn.
