...
$P_{2n}$, probability of returning to the origin after $2n$ steps, is given by the analogue of Equation~\ref{eq.return-to-origin1}:
\[
P_{2n} =
...
\label{eq.buffon2}E(R_n)&=&\sum_{i=1}^n E(\textsf{segments of}\;a_R)=a_RE(1)\,. 
\end{eqnarray}
}
