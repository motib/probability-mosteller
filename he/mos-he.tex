...
\newenvironment{prob}[4]{
  ...
  {\L{\bfseries\theproblem{}}.\ \bfseries #1 \L{\small #3}}
  {\L{\Large\bfseries\theproblem}.\ %
  \Large\bfseries #1 \L{\small\bfseries #3}%
...
\newcommand*{\sml}{\medskip\textbf{\Large סימולציה}\medskip}
